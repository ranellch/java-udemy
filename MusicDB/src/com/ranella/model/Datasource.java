...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\cr737d\\" + DB_NAME;
    ...
    public void close() {
        try {
            ...
            System.out.println("Couldn't close conection: " + e.getMessage());
        }
    }
    ...
    public void insertSong(String title, String artist, String album, int track) {
        try {
            ...
            try {
                System.out.println("Resetting deafault commit behavior");
